...
export const BUSINESS_TYPE_CONFIG: Record<BusinessType, BusinessTypeConfig> = {
  ...
  school: {
    ...
    formFields: {
      ...
      namePlaceholder: 'e.g., Tuition Fee - Term 1',
      highlightPlaceholder: 'e.g., Term 1',
      descriptionPlaceholder: 'Fee description...',
    ...
    layout: {
      defaultTab: 'dashboard',
      tabOrder: ['dashboard', 'customers', 'sales', 'receipts', 'inventory', 'accounts', 'hr', 'contacts', 'website'],
      hiddenTabs: ['shop', 'agents', 'messages', 'communities'],
      quickActions: [
        { id: 'collect-fee', label: 'Collect Fee', icon: 'CreditCard', targetTab: 'sales', highlight: true },
        { id: 'view-students', label: 'Student Records', icon: 'GraduationCap', targetTab: 'customers' },
        { id: 'fee-statements', label: 'Fee Statements', icon: 'FileText', targetTab: 'accounts' },
        { id: 'fee-structure', label: 'Fee Structure', icon: 'Package', targetTab: 'inventory' },
      ],
      kpiCards: [
        ...
        { id: 'students-enrolled', title: 'Students Enrolled', metric: 'students_enrolled', icon: 'GraduationCap', color: 'text-[#004B8D]', bgColor: 'bg-[#004B8D]/10', subtitle: 'Based on unique students' },
        { id: 'pending-fees', title: 'Outstanding Fees', metric: 'pending_invoices', icon: 'Clock', color: 'text-amber-600', bgColor: 'bg-amber-500/10' },
      ],
      welcomeMessage: 'Manage student enrollment, fees, and academic records',
  ...
  autoshop: {
    ...
    description: 'Sell vehicle parts and spares with repair services',
    inventory: {
      enabled: true,
      seedProfile: 'generic',
      allowVariants: true,
    ...
    formFields: {
      skuPlaceholder: 'e.g., BRK-TOY-2015',
      namePlaceholder: 'e.g., Front Brake Pads - Toyota Corolla 2015-2020',
      highlightPlaceholder: 'e.g., OEM Quality / Genuine Part',
      descriptionPlaceholder: 'Part specifications, vehicle compatibility, warranty...',
      featuresPlaceholder: 'OEM equivalent quality\nFits Toyota Corolla 2015-2020\n12 month warranty\nCeramic compound',
      categories: [
        { value: 'engine_parts', label: 'Engine Parts' },
        { value: 'filters', label: 'Filters & Fluids' },
      ...
      certificationsLabel: 'Quality Marks',
      certifications: [
        { value: 'oem', label: 'OEM Equivalent' },
        { value: 'genuine', label: 'Genuine Part' },
        { value: 'aftermarket', label: 'Aftermarket Quality' },
        { value: 'warranty_6m', label: '6 Month Warranty' },
        { value: 'warranty_12m', label: '12 Month Warranty' },
        { value: 'universal', label: 'Universal Fit' },
      ],
      defaultSpecs: [
        { label: 'Vehicle Compatibility', value: '' },
        { label: 'Part Number / OEM Ref', value: '' },
        { label: 'Brand / Manufacturer', value: '' },
