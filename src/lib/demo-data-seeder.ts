...
const inventoryTemplates: Record<string, Array<{
  ...
  fashion: [
    { name: "Chitenge Fabric (6 yards)", sku: "FAB-CHT-001", category: "clothing", unit_price: 250, cost_price: 180, quantity: 45, reorder_level: 10 },
    { name: "Italian Silk (per meter)", sku: "FAB-SLK-001", category: "clothing", unit_price: 450, cost_price: 320, quantity: 20, reorder_level: 5 },
    { name: "Cotton Blend (per meter)", sku: "FAB-COT-001", category: "clothing", unit_price: 150, cost_price: 100, quantity: 80, reorder_level: 20 },
    { name: "Ankara Print (6 yards)", sku: "FAB-ANK-001", category: "clothing", unit_price: 350, cost_price: 250, quantity: 35, reorder_level: 10 },
    { name: "Lace Material (per meter)", sku: "FAB-LAC-001", category: "clothing", unit_price: 280, cost_price: 200, quantity: 25, reorder_level: 8 },
    ...
    { name: "School Uniform Set", sku: "RTW-UNI-001", category: "uniform", unit_price: 450, cost_price: 280, quantity: 50, reorder_level: 15 },
  ],
  salon: [
    { name: "Ladies Haircut & Styling", sku: "SVC-HAIR-001", category: "hair", unit_price: 150, cost_price: 30, quantity: 999, reorder_level: 0 },
    { name: "Braiding (Full Head)", sku: "SVC-BRAID-001", category: "hair", unit_price: 350, cost_price: 50, quantity: 999, reorder_level: 0 },
    { name: "Relaxer Treatment", sku: "SVC-RELAX-001", category: "hair", unit_price: 280, cost_price: 80, quantity: 999, reorder_level: 0 },
    { name: "Weave Installation", sku: "SVC-WEAVE-001", category: "hair", unit_price: 500, cost_price: 100, quantity: 999, reorder_level: 0 },
    { name: "Manicure & Pedicure Set", sku: "SVC-NAILS-001", category: "nails", unit_price: 200, cost_price: 40, quantity: 999, reorder_level: 0 },
    { name: "Gel Nails (Full Set)", sku: "SVC-GEL-001", category: "nails", unit_price: 350, cost_price: 80, quantity: 999, reorder_level: 0 },
    { name: "Facial Treatment", sku: "SVC-FACIAL-001", category: "skincare", unit_price: 250, cost_price: 60, quantity: 999, reorder_level: 0 },
  ...
  healthcare: [
    { name: "General Consultation", sku: "SVC-CONSULT-001", category: "consultation_fee", unit_price: 200, cost_price: 50, quantity: 999, reorder_level: 0 },
    { name: "Specialist Consultation", sku: "SVC-SPEC-001", category: "consultation_fee", unit_price: 400, cost_price: 100, quantity: 999, reorder_level: 0 },
    { name: "Malaria Test", sku: "SVC-TEST-MAL", category: "test", unit_price: 80, cost_price: 25, quantity: 999, reorder_level: 0 },
    { name: "Blood Pressure Check", sku: "SVC-BP-001", category: "test", unit_price: 50, cost_price: 10, quantity: 999, reorder_level: 0 },
    { name: "Blood Sugar Test", sku: "SVC-GLU-001", category: "test", unit_price: 100, cost_price: 30, quantity: 999, reorder_level: 0 },
  ...
  retail: [
    { name: "Cooking Oil (2L)", sku: "GRO-OIL-2L", category: "food", unit_price: 95, cost_price: 75, quantity: 100, reorder_level: 30 },
    { name: "Mealie Meal (25kg)", sku: "GRO-MEAL-25", category: "food", unit_price: 280, cost_price: 220, quantity: 50, reorder_level: 15 },
    { name: "Sugar (2kg)", sku: "GRO-SUG-2", category: "food", unit_price: 65, cost_price: 50, quantity: 80, reorder_level: 25 },
    { name: "Rice (5kg)", sku: "GRO-RICE-5", category: "food", unit_price: 120, cost_price: 90, quantity: 60, reorder_level: 20 },
    { name: "Bread Loaf", sku: "BAK-BREAD-001", category: "food", unit_price: 22, cost_price: 15, quantity: 40, reorder_level: 15 },
    { name: "Eggs (tray of 30)", sku: "DAI-EGG-30", category: "food", unit_price: 85, cost_price: 65, quantity: 25, reorder_level: 10 },
    { name: "Milk (1L)", sku: "DAI-MILK-1L", category: "food", unit_price: 28, cost_price: 20, quantity: 50, reorder_level: 20 },
    { name: "Soft Drink (2L)", sku: "BEV-SODA-2L", category: "food", unit_price: 35, cost_price: 25, quantity: 100, reorder_level: 30 },
  ...
  agriculture: [
    ...
    { name: "Fertilizer D-Compound (50kg)", sku: "FER-DCOM-50", category: "fertilizer", unit_price: 850, cost_price: 650, quantity: 50, reorder_level: 15 },
    { name: "Urea Fertilizer (50kg)", sku: "FER-UREA-50", category: "fertilizer", unit_price: 750, cost_price: 580, quantity: 40, reorder_level: 12 },
    { name: "Pesticide (5L)", sku: "CHE-PEST-5L", category: "equipment", unit_price: 280, cost_price: 200, quantity: 30, reorder_level: 10 },
    { name: "Herbicide (5L)", sku: "CHE-HERB-5L", category: "equipment", unit_price: 320, cost_price: 240, quantity: 25, reorder_level: 8 },
    { name: "Chicken Feed (50kg)", sku: "FED-CHK-50", category: "livestock", unit_price: 380, cost_price: 300, quantity: 60, reorder_level: 20 },
  ...
  services: [
    { name: "Consulting (per hour)", sku: "SVC-CONS-HR", category: "consultation", unit_price: 500, cost_price: 100, quantity: 999, reorder_level: 0 },
    { name: "Project Management", sku: "SVC-PM-001", category: "project", unit_price: 2500, cost_price: 500, quantity: 999, reorder_level: 0 },
    ...
    { name: "Document Preparation", sku: "SVC-DOC-001", category: "support", unit_price: 200, cost_price: 50, quantity: 999, reorder_level: 0 },
    { name: "Website Development", sku: "SVC-WEB-001", category: "project", unit_price: 5000, cost_price: 1000, quantity: 999, reorder_level: 0 },
  ...
  hospitality: [
    ...
    { name: "Deluxe Room (per night)", sku: "ROM-DLX-001", category: "accommodation", unit_price: 750, cost_price: 250, quantity: 5, reorder_level: 0 },
    { name: "Executive Suite (per night)", sku: "ROM-EXE-001", category: "accommodation", unit_price: 1200, cost_price: 400, quantity: 2, reorder_level: 0 },
    { name: "Continental Breakfast", sku: "FNB-BRK-001", category: "food_beverage", unit_price: 120, cost_price: 45, quantity: 999, reorder_level: 0 },
    { name: "Lunch Buffet", sku: "FNB-LUN-001", category: "food_beverage", unit_price: 180, cost_price: 70, quantity: 999, reorder_level: 0 },
    { name: "Dinner (3 course)", sku: "FNB-DIN-001", category: "food_beverage", unit_price: 250, cost_price: 100, quantity: 999, reorder_level: 0 },
    { name: "Conference Room (per day)", sku: "CNF-ROOM-001", category: "events", unit_price: 2500, cost_price: 500, quantity: 3, reorder_level: 0 },
  ],
  ngo: [
    { name: "Community Training Session", sku: "PRG-TRAIN-001", category: "education", unit_price: 0, cost_price: 500, quantity: 999, reorder_level: 0 },
    { name: "Health Outreach Visit", sku: "PRG-HEALTH-001", category: "medical", unit_price: 0, cost_price: 300, quantity: 999, reorder_level: 0 },
    ...
    { name: "First Aid Kit", sku: "SUP-FAID-001", category: "medical", unit_price: 250, cost_price: 180, quantity: 50, reorder_level: 15 },
    { name: "Water Purification Tablets", sku: "SUP-WATER-001", category: "relief", unit_price: 35, cost_price: 20, quantity: 500, reorder_level: 100 },
    { name: "Mosquito Nets (pack of 10)", sku: "SUP-NET-010", category: "relief", unit_price: 200, cost_price: 120, quantity: 100, reorder_level: 30 },
  ],
  school: [
    { name: "Tuition Fee (per term)", sku: "FEE-TUIT-001", category: "tuition", unit_price: 2500, cost_price: 1500, quantity: 999, reorder_level: 0 },
    { name: "Boarding Fee (per term)", sku: "FEE-BOARD-001", category: "tuition", unit_price: 3500, cost_price: 2500, quantity: 999, reorder_level: 0 },
    { name: "Exam Fee", sku: "FEE-EXAM-001", category: "tuition", unit_price: 350, cost_price: 200, quantity: 999, reorder_level: 0 },
  ...
  distribution: [
    { name: "Coca-Cola (case of 24)", sku: "BEV-COKE-24", category: "food", unit_price: 180, cost_price: 140, quantity: 200, reorder_level: 50 },
    { name: "Fanta (case of 24)", sku: "BEV-FANT-24", category: "food", unit_price: 180, cost_price: 140, quantity: 150, reorder_level: 40 },
    { name: "Castle Lager (crate)", sku: "BEV-BEER-001", category: "food", unit_price: 280, cost_price: 220, quantity: 100, reorder_level: 30 },
    { name: "Mosi Lager (crate)", sku: "BEV-MOSI-001", category: "food", unit_price: 260, cost_price: 200, quantity: 80, reorder_level: 25 },
    { name: "Maheu (case of 12)", sku: "BEV-MAHE-12", category: "food", unit_price: 120, cost_price: 90, quantity: 100, reorder_level: 30 },
    { name: "Cooking Oil (case of 12)", sku: "GRO-OIL-12", category: "food", unit_price: 960, cost_price: 780, quantity: 50, reorder_level: 15 },
  ...
  hybrid: [
    ...
    { name: "Maintenance Package", sku: "SVC-MAINT-001", category: "packages", unit_price: 800, cost_price: 200, quantity: 999, reorder_level: 0 },
    { name: "Accessory Pack", sku: "PRD-ACC-001", category: "accessories", unit_price: 80, cost_price: 45, quantity: 100, reorder_level: 30 },
  ],
};
