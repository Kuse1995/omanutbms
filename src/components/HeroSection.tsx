...
const staticSlides = [
  ...
  {
    id: "distributors",
    tagline: "Your Trusted LifeStraw Partner",
    headline: "Exclusive Distributors",
    headlineAccent: "in Zambia",
    description: "Finch Investments brings world-class water purification to families, schools, and communities across the region.",
