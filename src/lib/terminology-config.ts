...
const terminologyMaps: Record<BusinessType, TerminologyMap> = {
  ...
  autoshop: {
    salesLabel: 'Sales',
    salesDescription: 'Record and manage parts sales',
    transactionLabel: 'Sale',
    transactionsLabel: 'Sales',
    revenueLabel: 'Sales Revenue',
    customerLabel: 'Customer',
    customersLabel: 'Customers',
    customerIdLabel: 'Customer ID',
    inventoryLabel: 'Parts & Spares',
    productLabel: 'Auto Part',
    productsLabel: 'Auto Parts',
    ...
    invoicesLabel: 'Invoices',
    impactLabel: 'Impact',
    impactUnitLabel: 'Parts Sold',
    impactDescription: 'Track your sales impact',
    communityLabel: 'Supplier',
    communitiesLabel: 'Suppliers',
  },
  hybrid: {
